...
# video capture
capture = cv2.VideoCapture(2) # I have a few virtual webcams on my system so built-in one is indexed as 2 
...
while True:
    ...
    try:
        ...
        cv2.putText(img, f'{count_defects + 1}',(50,50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
