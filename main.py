...
# Frame Cropping
    ...
    try:
        ...
        if count_defects == 0:
            cv2.putText(img, "ONE",(50,50), cv2.FONT_HERSHEY_SIMPLEX, 2, (255,0,0), 2)
        # elif count_defects == 1:
        elif count_defects == 1:
            cv2.putText(img, "TWO",(50,50), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,255,0), 2)
        elif count_defects == 2:
            cv2.putText(img, "THREE",(50,50), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,0,255), 2)
        elif count_defects == 3:
            cv2.putText(img, "FOUR",(50,50), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,255,255), 2)
        elif count_defects == 4:
            cv2.putText(img, "FIVE",(50,50), cv2.FONT_HERSHEY_SIMPLEX, 2, (255,255,0), 2)
