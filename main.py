...
while True:
    ...
    try:
        ...
        if count_defects == 0:
            cv2.putText(img, "ONE", (350, 250), cv2.FONT_HERSHEY_COMPLEX, 2, 2)
        elif count_defects == 1:
            cv2.putText(img, "TWO", (350, 250), cv2.FONT_HERSHEY_COMPLEX, 2, 2)
        elif count_defects == 2:
            cv2.putText(img, "THREE", (350, 250), cv2.FONT_HERSHEY_COMPLEX, 2, 2)
        elif count_defects == 3:
            cv2.putText(img, "FOUR", (350, 250), cv2.FONT_HERSHEY_COMPLEX, 2, 2)
        elif count_defects == 4:
            cv2.putText(img, "FIVE", (350, 250), cv2.FONT_HERSHEY_COMPLEX, 2, 2)
        else:
            pass
    except:
        pass
