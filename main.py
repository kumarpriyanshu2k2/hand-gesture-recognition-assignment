...
while True:
    ...
    try:
        ...
        if count_defects == 0:
            cv2.putText(img, "ONE", (600, 100), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
        elif count_defects == 1:
            cv2.putText(img, "TWO", (600, 100), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
        elif count_defects == 2:
            cv2.putText(img, "THREE", (600, 100), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
        elif count_defects == 3:
            cv2.putText(img, "FOUR", (600, 100), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
        elif count_defects == 4:
            cv2.putText(img, "FIVE", (600, 100), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
