...
while True:
    ...
    # Frame Cropping
    cv2.rectangle(img, (0,0), (320, 288), (0, 255, 0), 0)
    crop_image = img[0:288, 0:320]
    ...
    try:
        ...
        # (important: do not use returnPoints argument)
        ...
        # (important: use returnPoints argument as False)
        ...
        if count_defects == 0:
            cv2.putText(img, "ONE", (250, 50), cv2.FONT_HERSHEY_TRIPLEX, 2, 2)
        elif count_defects == 1:
            cv2.putText(img, "TWO", (250, 50), cv2.FONT_HERSHEY_TRIPLEX, 2, 2)
        elif count_defects == 2:
            cv2.putText(img, "THREE", (250, 50), cv2.FONT_HERSHEY_TRIPLEX, 2, 2)
        elif count_defects == 3:
            cv2.putText(img, "FOUR", (250, 50), cv2.FONT_HERSHEY_TRIPLEX, 2, 2)
        elif count_defects == 4:
            cv2.putText(img, "FIVE", (250, 50), cv2.FONT_HERSHEY_TRIPLEX, 2, 2)
        else:
            pass
