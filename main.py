...
while True:
    ...
    # Frame Cropping
    cv2.rectangle(img, (0, 0), (550, 600), (0, 255, 0), 0)
    crop_image = img[0:550, 0:600]
    ...
    try:
        ...
        if count_defects == 0:
            cv2.putText(img, "ONE", (400, 50), cv2.FONT_HERSHEY_DUPLEX, 2, 2)
        elif count_defects == 1:
            cv2.putText(img, "TWO", (400, 50), cv2.FONT_HERSHEY_DUPLEX, 2, 2)
        elif count_defects == 2:
            cv2.putText(img, "THREE", (400, 50), cv2.FONT_HERSHEY_DUPLEX, 2, 2)
        elif count_defects == 3:
            cv2.putText(img, "FOUR", (400, 50), cv2.FONT_HERSHEY_DUPLEX, 2, 2)
        elif count_defects == 4:
            cv2.putText(img, "FIVE", (400, 50), cv2.FONT_HERSHEY_DUPLEX, 2, 2)
        else:
            pass
