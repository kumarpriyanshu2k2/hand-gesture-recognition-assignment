...
# Frame Cropping
    ...
    try:
        ...
        if count_defects == 0:
            cv2.putText(img, "ONE",(50,50), cv2.FONT_HERSHEY_SIMPLEX, 2,(255,0,255), 2)
        # elif count_defects == 1:
            ...
            cv2.putText(img, "FOUR",(50,50), cv2.FONT_HERSHEY_SIMPLEX, 2,(255,0,0), 2)
        elif count_defects == 4:
            cv2.putText(img, "FIVE",(50,50), cv2.FONT_HERSHEY_SIMPLEX, 2,(0,0,0), 2)
