# -*- coding: utf-8 -*-
"""
Created on Mon Dec 19 20:16:41 2022
...
while True:
    ...
    try:
        ...
        hull = cv2.Hull(contour, returnPoints=False)
   ...
   # calculating the angle using cosine formula
        ...
        if count_defects == 0:
            cv2.putText(img, "ONE",(50,50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2,cv2.LINE_AA)
        # elif count_defects == 1:
        elif count_defects>0:
             count_defects=count_defects+1
             cv2.putText(img,str(count),(50,50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2,cv2.LINE_AA)
